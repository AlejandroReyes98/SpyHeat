...
# -*- coding: utf-8 -*-
"""
Created on Tue Dec 29 23:52:26 2020
...
import pandas as ps
import Funciones_Estacionaria as fun
import time
from tkinter import *
...
def calcConv():
	...
	h,x,lar,r,p = fun.Constantes(a,b,N,K,v)
	print("\n-------------------------------------------------")
	...
	A = fun.Matriz_Diagonal_Conv_Est(N,r,p,v,K,h)
	...
	xa, ua = fun.Sol_Analitica(a,b,K,N,v,lar,p,Tb,Ta)
	...
	for n in range(1,N+1):
	    ...
	    if (n % 100==0):
	        etiqueta = 'Sol. Num. steep = {}'.format(n*h)
...
root.title("Conveccion Estacionaria en 1D")
